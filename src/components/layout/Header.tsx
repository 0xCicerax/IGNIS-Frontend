    ...
    return (
        <header className="header">
            <div className="header__container">
                ...
                {/* Right Side - Transactions, Chain & Wallet */}
                                    ...
                                    {connected ? (
                                        <>
                                            ...
                                            <button
                                                ...
                                                className={`header__chain-btn hide-mobile ${chain.unsupported ? 'header__chain-btn--unsupported' : 'header__chain-btn--connected'}`}
                                                aria-label={chain.unsupported ? 'Wrong network - click to switch' : `Current network: ${chain.name}`}
                                            >
                                                {chain.unsupported ? (
                                                    'Wrong Network'
                                                ) : (
                                                    <>
                                                        {chain.hasIcon && chain.iconUrl && (
                                                            <img
                                                                src={chain.iconUrl}
                                                                alt=""
                                                                className="header__chain-icon"
                                                                aria-hidden="true"
                                                            />
                                                        )}
                                                        {!chain.hasIcon && (
                                                            <div className="header__chain-dot" aria-hidden="true" />
                                                        )}
                                                        {chain.name}
                                                    </>
                                                )}
                                            ...
                                            <button
                                                ...
                                                aria-label={`Account: ${account.displayName}${account.displayBalance ? `, Balance: ${account.displayBalance}` : ''}`}
                                            >
