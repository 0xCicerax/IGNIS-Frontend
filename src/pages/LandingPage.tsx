        ...
        <header className={`landing-header ${scrolled ? 'landing-header--scrolled' : ''}`}>
            <div className="landing-header__container">
                ...
                <div className="landing-header__cta">
                    ...
                    <button className="landing-btn landing-btn--primary" onClick={() => navigate('/app')}>Launch App →</button>
                </div>
    ...
    return (
        <section className="landing-hero">
            ...
            <div className="landing-hero__actions">
                <button className="landing-btn landing-btn--primary landing-btn--large" onClick={() => navigate('/app')}>Launch App</button>
